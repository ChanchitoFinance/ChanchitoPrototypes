          ...
          <div className="px-4 md:px-6 py-8">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                {/* Space Media Sidebar */}
                {spaceMedia && (
                  <div className="hidden lg:flex flex-shrink-0 items-start justify-center pt-12 w-80">
                    <div className="relative w-full aspect-[3/4] rounded-lg overflow-hidden bg-gradient-to-br from-accent/20 via-background to-accent/10 flex items-center justify-center">
                      {space.settings?.space_video ? (
                        <video
                          src={space.settings.space_video}
                          className="w-full h-full object-contain"
